...
- Guoke Luo, **Hao Zhang**† (Corresponding author). Adaptive Bipedal Locomotion on Time-Varying Footholds. IEEE‑RAS International Conference on Humanoid Robots, 2026, under review.
...
- Yuanhanxu Song, Xiang Gao, **Hao Zhang**† (Corresponding author). Coordination Residual Learning for Multi-Humanoid Loco-Manipulation. IEEE‑RAS International Conference on Humanoid Robots, 2026, under review.
